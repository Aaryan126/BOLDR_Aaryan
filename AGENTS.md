...
- Current implementation reaches Phase 4: local ingestion, deterministic classification, and explainable retrieval evidence. Retrieval APIs live under `/api/retrieval/*`.
