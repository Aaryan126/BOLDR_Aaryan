...
- Current implementation reaches Phase 7: local ingestion, deterministic classification, explainable retrieval evidence, structured AI provider contracts, evidence-gated reply drafting, and stable workflow APIs.
